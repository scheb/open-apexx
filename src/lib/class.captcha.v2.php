...
{
    public $bgnoise = false;
    public $width = 60;
    public $height = 25;

    public $size = [16];
    public $font = [1, 2, 3, 4, 5, 6, 7, 8, 9];
    //var $charspace = array(2,3,4,5,6,8,9);
    public $charspace = '2345689abcdefghkmpqrstwxyzABCDEFGHKMPQRSTWXYZ';
    public $angle = [
        'min' => -30,
        'max' => 30,
    ];
    ...
    public function createCaptchaCode($picture, $bgColor)
    {
    ...
    public function image2Html($picture, $bgColor)
    {
        $im = $picture;
        $intWidth = $this->width;
    ...
    public function get_background(&$picture)
    {
    ...
    //Zufällige Hintergrundfarbe
    public function get_middleground(&$picture)
    {
        $color = imagecolorallocate(
            $picture,
    ...
    public function get_foreground(&$picture)
    {
        $color = imagecolorallocate(
            $picture,
