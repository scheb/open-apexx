...
class EpiTwitter extends EpiOAuth
{
    ...
    private function request($method, $endpoint, $params = null)
    {
        ...
        $resp = new EpiTwitterJson(call_user_func([$this, 'httpRequest'], $method, $url, $params, $this->isMultipart($params)), $this->debug);
...
class EpiTwitterJson implements ArrayAccess, Countable, IteratorAggregate
{
    ...
    {
        $accessible = ['responseText' => 1, 'headers' => 1, 'code' => 1];
        ...
        if (($this->code < 200 || $this->code >= 400) && !isset($accessible[$name])) {
