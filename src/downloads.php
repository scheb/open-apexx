...
if ('search' == $_REQUEST['action']) {
    ...
    if ($_REQUEST['searchid']) {
        ...
        $catinfo = [];
        if (count($catids) && in_template(['DOWNLOAD.CATTITLE', 'DOWNLOAD.CATTEXT', 'DOWNLOAD.CATICON'], $parse)) {
...
$orderdef['uploader'] = ['b.username', 'ASC'];
$orderdef['author'] = ['a.author', 'ASC'];
